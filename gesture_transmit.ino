...
//collects Raw-data from MPU-6050 and converts it into Euler's Angle 
// further Data is transmitted using 433Mhz transmitter.
...
const int led_pin = 11; // PIN declaration for RF transmitter & receiver pair.
